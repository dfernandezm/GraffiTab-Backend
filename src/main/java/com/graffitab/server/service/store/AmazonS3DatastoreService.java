...
import com.graffitab.server.service.TransactionUtilsService;
...
public class AmazonS3DatastoreService implements DatastoreService {
	...
	public void setupClient() {
		...
		BasicAWSCredentials awsCreds = new BasicAWSCredentials(awsKey,
				awsSecret);
	...
	public void saveAsset(InputStream inputStream, long contentLength, String userGuid,
			String assetGuid, AssetType assetType, Map<String, String> metadata) {
