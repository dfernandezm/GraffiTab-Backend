...
```
curl -i -H "Content-Type: application/json" --cookie "JSESSIONID=E9DFBB37EC490A08BAA19295360F1EFA" http://localhost:8090/api/users
```
...
```
curl -i -H "Content-Type: application/json" -X POST -d '{ "externalProvider":{ "externalId":"123456789", "accessToken":"hsadoaoi98a7sdiausdi", "externalProviderType":"TWITTER"}}' http://localhost:8091/api/users/externalprovider/verify
```
